...
SECRET_KEY = 'e%_-kg_74r%cue!l&ygdbnl$e97)q&zf^w+4j9154w4hc3mhuv'
...
INSTALLED_APPS = [
    'blog.apps.BlogConfig',#potrzebne, aby dodac templates'y
    'users.apps.UsersConfig',#potrzebne, aby dodac templates'y
    'crispy_forms',
